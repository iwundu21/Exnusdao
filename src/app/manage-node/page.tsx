    ...
    <div className="max-w-6xl mx-auto px-10 py-16 space-y-12 animate-in fade-in duration-500 pb-32">
      ...
      <div className="grid grid-cols-1 gap-10">
        {myNodes.map((node) => {
          ...
          return (
            <div key={node.id} className="exn-card p-0 border-white/20 relative overflow-hidden group bg-black/80 backdrop-blur-3xl shadow-3xl">
              <div className="absolute top-0 right-0 p-10 z-10">
                 <div className={`flex items-center gap-3 text-[11px] font-black uppercase px-6 py-2.5 rounded-xl border backdrop-blur-3xl ${node.is_active ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/40 shadow-[0_0_30px_rgba(16,185,129,0.3)]' : 'bg-destructive/10 text-destructive border-destructive/40'}`}>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-12">
                <div className="xl:col-span-4 p-10 border-r border-white/10 space-y-12">
                  <div className="flex items-center gap-6">
                    <div className="relative w-24 h-24 rounded-2xl overflow-hidden border-2 border-white/20 shadow-3xl">
                  ...
                  <div className="p-8 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl space-y-8 relative overflow-hidden group/yield shadow-2xl">
                  ...
                  {isEditing ? (
                    <div className="space-y-12 animate-in fade-in zoom-in-95 duration-700">
                      ...
                      <div className="flex gap-6 pt-6">
                        <button onClick={() => setReviewAction('update')} className="exn-button flex-1 h-14 uppercase font-black tracking-[0.4em] text-[12px]">SYNCHRONIZE_PATCH</button>
                        <button onClick={() => setEditingNodeId(null)} className="exn-button-outline flex-1 h-14 uppercase font-black tracking-[0.4em] text-[12px] border-white/20 text-white hover:bg-white/10">ABORT_SEQUENCE</button>
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-12">
                         ...
                         <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                               ...
                               {!node.seed_deposited ? (
                                 ...
                                 <button onClick={() => handleWithdrawSeed(node.id)} className="h-14 bg-primary/15 text-primary border border-primary/40 uppercase text-[11px] font-black tracking-[0.4em] rounded-2xl hover:bg-primary/25 transition-all">WITHDRAW_SEED</button>
                               )}
                            </div>
                         </div>
                      </div>
                      ...
                      <div className="space-y-8 border-t border-white/10 pt-12">
                         ...
                         <div className="p-10 bg-destructive/10 border border-destructive/30 rounded-2xl space-y-8 shadow-3xl">
                            ...
                            <button onClick={() => setReviewAction('terminate')} className="w-full h-14 bg-destructive text-white uppercase text-[11px] font-black tracking-[0.5em] rounded-2xl hover:opacity-90 active:scale-95 transition-all shadow-3xl">
