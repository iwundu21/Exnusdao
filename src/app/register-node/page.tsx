            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full py-3 border border-primary/20 text-primary text-[10px] font-black uppercase rounded-lg hover:bg-primary/10 transition-all flex items-center justify-center gap-2"
                >
                  <Upload className="w-4 h-4" /> Upload Identity Logo
                </button>
                
                <div className="p-4 bg-foreground/5 rounded-xl border border-border space-y-2 text-center">
