...
export default function ProtocolSpecPage() {
  ...
  const sections = [
    {
      id: "infrastructure",
      title: "LAYER 0: XNODE SCARCITY MODEL",
    ...
    {
      id: "seed-lifecycle",
      title: "LAYER 1: SEED CAPITAL & OFFLINE STATE",
    ...
    {
      id: "termination",
      title: "LAYER 2: PERMANENT TERMINATION & NFT BURN",
    ...
    {
      id: "migration",
      title: "LAYER 3: ATOMIC STAKE MIGRATION",
    ...
    {
      id: "governance",
      title: "LAYER 4: DAO CONSENSUS & TRANSACTION PROPOSALS",
    ...
    {
      id: "rewards",
      title: "LAYER 5: REWARD SHARDING & EPOCH SETTLEMENT",
    ...
    <div className="max-w-5xl mx-auto px-6 py-12 lg:py-24 space-y-16 animate-in fade-in duration-700 pb-40">
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          <p className="text-[11px] font-black uppercase tracking-[0.5em] text-primary">EXNUS PROTOCOL SPEC V3.5.0 STABLE</p>
        </div>
        <h1 className="text-5xl lg:text-7xl font-black exn-gradient-text tracking-tighter uppercase leading-none">NETWORK BLUEPRINTS</h1>
            ...
            <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-6">
                 ...
                 <div className="flex items-center gap-3 text-[10px] font-black text-primary uppercase tracking-[0.4em]">
                   ON CHAIN VERIFIED PROTOCOL LAYER
                 </div>
              </div>
            </div>
          </div>
      ...
      <div className="exn-card p-12 bg-primary/5 border-primary/40 text-center space-y-8 shadow-3xl">
        <div className="space-y-3">
          <h3 className="text-2xl font-black text-white uppercase tracking-tighter">ESTABLISH INFRASTRUCTURE</h3>
