    ...
    <div className="max-w-5xl mx-auto px-10 py-20 space-y-20 animate-in fade-in duration-700 pb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <ul className="space-y-4 text-sm text-muted-foreground list-disc pl-5">
                <li><span className="text-foreground font-bold">Reward Cap:</span> Initialized at <span className="text-primary font-bold">0</span>. Admin must configure via Front-end.</li>
                <li><span className="text-foreground font-bold">License Price:</span> Initialized at <span className="text-primary font-bold">0</span>. Admin must configure via Front-end.</li>
        ...
        <div className="exn-card p-10 border-primary/20 bg-primary/5">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="space-y-8">
                 <h5 className="text-[10px] font-black uppercase text-muted-foreground">Core Protocol PDAs</h5>
                 <div className="space-y-4">
              ...
              <div className="p-6 bg-black/20 rounded-2xl border border-border space-y-6">
                 ...
                 <p className="text-sm text-muted-foreground leading-relaxed">
                   ...
                   Accounting is handled dynamically via isolated Stake PDAs.
                 </p>
              </div>
           </div>
        </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                 ...
                 <ul className="space-y-4 text-sm text-muted-foreground list-disc pl-5">
                    ...
                    <li><span className="text-foreground font-bold">Dynamic Record:</span> Create Stake PDA to track duration and principal.</li>
                    <li><span className="text-foreground font-bold">Weight:</span> Snapshot current Validator Reward Index for claim calculation.</li>
                 </ul>
              </div>
              <div className="space-y-6">
                 ...
                 <ul className="space-y-4 text-sm text-muted-foreground list-disc pl-5">
                    <li><span className="text-foreground font-bold">Maturity Check:</span> Cluster time must be {'>='} Stake Unlock Timestamp.</li>
                    <li><span className="text-foreground font-bold">Principal Transfer:</span> <span className="text-primary font-bold">Global Staked Vault</span> → User Wallet.</li>
                    <li><span className="text-foreground font-bold">Double Spend:</span> Account record is updated/closed to prevent multiple withdrawals.</li>
                 </ul>
              </div>
           </div>
        </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pt-6">
              <div className="space-y-6">
                 ...
                 <ol className="space-y-4 text-sm text-muted-foreground list-decimal pl-5 leading-relaxed">
                    <li><span className="text-foreground font-bold">Lifecycle:</span> System operates for 10 years (approx. 260 blocks).</li>
                    <li><span className="text-foreground font-bold">Index-Based:</span> First crank initializes Block <span className="text-primary font-bold">1000</span>.</li>
      ...
      <section className="space-y-10">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-3xl font-bold uppercase tracking-widest">8. Governance & Voting</h2>
        </div>
        <div className="exn-card p-10 border-secondary/20 bg-secondary/5 space-y-10">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                 ...
                 <ul className="space-y-4 text-sm text-muted-foreground list-disc pl-5">
                    <li><span className="text-foreground font-bold">Min Requirement:</span> User must have <span className="text-primary font-bold underline">10,000 EXN</span> currently staked.</li>
                    <li><span className="text-foreground font-bold">Mandatory Input:</span> Votes without a rationale (comment) string must revert.</li>
                    <li><span className="text-foreground font-bold">Governance Window:</span> Exactly 7 days (168 hours).</li>
                 </ul>
              </div>
              <div className="p-6 bg-background/60 rounded-2xl border border-border space-y-6">
                 <div className="flex items-center gap-2 text-amber-500">
                    <ShieldAlert className="w-4 h-4" />
                    <p className="text-[10px] font-black uppercase">Consensus Lock Window</p>
                 </div>
                 <p className="text-sm text-muted-foreground leading-relaxed">
                   To prevent "flash-voting" and ensure community scrutiny, the program implements a <span className="text-amber-500 font-bold underline">4-Hour Lock</span>. 
                   Voting is disabled when a proposal has less than 4 hours remaining.
                 </p>
              </div>
           </div>
        </div>
