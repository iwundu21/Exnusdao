            ...
            >
              ...
              <div className="p-10 space-y-12">
                <div className="space-y-5">
                  ...
                  <p className="text-[12px] text-white/60 leading-relaxed font-medium italic line-clamp-2 min-h-[3.5rem] tracking-tight">
                ...
                <button 
                  ...
                  className={`w-full text-[12px] h-16 uppercase font-black tracking-[0.4em] rounded-xl transition-all duration-500 shadow-2xl ${
                    validator.is_active 
